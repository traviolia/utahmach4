...
/*
 * HISTORY
 * $Log: e_cmu_43ux_sysent.c,v $
 * Revision 1.1.1.1  1995/03/02  21:49:29  mike
 * Initial Lites release from hut.fi
 *
 */
/*
 *	File:	emulator/e_cmu_43ux_sysent.c
 *	Author:	Johannes Helander, Helsinki University of Technology, 1994.
 *	Date:	May 1994
 *
 *	System call switch table for old UX binaries.
 */
...
int e_cmu_43ux_mmap(), e_cmu_43ux_sigreturn(), e_sigpause();
int e_mapped_gettimeofday(), e_bsd_sigprocmask();

int e_bnr_lseek(), e_bnr_stat(), e_bnr_lstat(), e_bnr_fstat();
int e_bnr_truncate(), e_bnr_ftruncate(), e_bnr_getdirentries();
int e_bnr_getrlimit(), e_bnr_setrlimit(), e_bnr_wait4(), e_bnr_shmsys();
int e_bnr_recvmsg(), e_bnr_accept(), e_bnr_recvfrom(), e_bnr_sendmsg();
int e_bnr_getpeername(), e_bnr_getsockname();

struct sysent e_cmu_43ux_sysent[] = {
	SYS_NULL(e_indir),				/* 0 */
	sysg(exit, 1),					/* 1 */
	...
	sysg(e_geteuid, 0),				/* 25 */
	sysg(e_ptrace, 4),				/* 26 */
	sysg(e_bnr_recvmsg, 3),				/* 27 */
	sysg(e_bnr_sendmsg, 3),				/* 28 */
	sysg(e_bnr_recvfrom, 6),			/* 29 */
	sysg(e_bnr_accept, 3),				/* 30 */
	sysg(e_bnr_getpeername, 3),			/* 31 */
	sysg(e_bnr_getsockname, 3),			/* 32 */
	sysg(e_access, 2),				/* 33 */
	sysg(e_chflags, 2),				/* 34 */
	...
	sysg(e_send, 4),				/* 101 */
	sysg(e_recv, 4),				/* 102 */
	sysg(e_cmu_43ux_sigreturn, 1),			/* 103 */
	sysg(e_bind, 3),				/* 104 */
	...
	sysg(e_bnr_getdirentries, 4), /* != 4.4 */	/* 164 */
	sysg(e_nosys, 0),				/* 165 */
	sysg(e_nosys, 0),				/* 166 */
	sysg(e_nosys, 0),				/* 167 */
	sysg(e_nosys, 0),				/* 168 */
...
int	e_cmu_43ux_nsysent = sizeof(e_cmu_43ux_sysent)/sizeof(struct sysent);
